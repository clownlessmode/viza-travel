      ...
      <div className="flex flex-col gap-[14px]">
        ...
        <div className="bg-white rounded-[48px] xl:p-[48px] sm:p-[24px] p-[20px]">
          <Image
            ...
            src={`/blocks/docs/policy/${localecode}/policy-1920-1280.svg`}
            alt="doc"
            width={1920}
            height={4000}
          />
          <Image
            ...
            src={`/blocks/docs/policy/${localecode}/policy-1280-640.svg`}
            alt="doc"
            width={1920}
            height={4000}
          />
          <Image
            ...
            src={`/blocks/docs/policy/${localecode}/policy-320.svg`}
            alt="doc"
            width={1920}
            height={4000}
          />
